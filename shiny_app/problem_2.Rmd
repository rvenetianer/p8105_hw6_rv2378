...
Column {.sidebar}
-----------------------------------------------------------------------
This `flexdashboard` with Shiny was made for Homework 6 of [Jeff Goldsmith's Data Science I class](http://jeffgoldsmith.com/DSI/homework_6.html) in the Department of Biostatistics at Columbia University. 
...
plot_ly(x = ~wahi_bakery$inspection_type, y = ~wahi_bakery$score, color = ~wahi_bakery$inspection_type, type = "bar")
